                    ...
                    <form method="POST" action="Preguntas.jsp">
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2"></div>
                                <div class="col-sm-2">
                                    <button id="borde1" type="button" class="btn btn-warning active respuesta" onclick="activar('Confirmar', value)" value="<%= resp.get(0)%>"><%= resp.get(0)%></button>
                                </div>
                                <div class="col-sm-1"></div>
                                <div class="col-sm-2">
                                    <button id="borde2" type="button" class="btn btn-warning active respuesta" onclick="activar('Confirmar', value)" value="<%= resp.get(1)%>"><%= resp.get(1)%></button>
                                </div>
                                <div class="col-sm-1"></div>
                                <div class="col-sm-2">
                                    <button id="borde3" type="button" class="btn btn-warning active respuesta" onclick="activar('Confirmar', value)" value="<%= resp.get(2)%>"><%= resp.get(2)%></button>
                                </div>
                                <div class="col-sm-2"></div>
                            </div>
                            <br>
